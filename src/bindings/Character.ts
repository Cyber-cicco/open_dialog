 ...
 * stats
 */
export type Character = { id: string, full_name: string, description: string | null, portrait_link: string | null, artwork_link: string | null, background_link: string | null, project_id: string, };
